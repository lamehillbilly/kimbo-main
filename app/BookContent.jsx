  ...
  <>
    ...
    <div className="justify-center flex  md:hidden text-2xl overflow-hidden bg-[#1f294a] m-4 rounded-lg bg-opacity-65 py-4">
      <div className={myFont.className}>
        ...
        <div className="flex flex-col text-center items-center m-5"><Link href="https://searchavax.com/v1/0xc3482f010b53a8a5681f5054d590200b896a711ae28c786aefe74c1250814f0f">🔥Liquidity Burned🔥</Link></div>
        <div className="flex font-bold text-cente m-5 flex-col"><div className="flex flex-col text-center">✅Contract Renounced✅</div> </div>
        <div className="flex font-bold text-cente m-5 flex-col text-center"><div className="flex flex-col text-center">Contract:</div> <div className="flex flex-col text-[22px] underline"><Link href="https://searchavax.com/v1/0x184ff13B3EBCB25Be44e860163A5D8391Dd568c1"> CLICK HERE</Link></div></div>
      </div>
    </div>
    </>
  );
