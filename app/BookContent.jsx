...
export const BookContent = () => (
    <div className="p-8 justify-center flex w-[800px] h-[370px] bg-[url('/main-content.png')] bg-no-repeat text-2xl">
      <div className={myFont.className}>
        ...
        <div className="flex font-bold text-cente m-5 flex-col"><div className="flex flex-col text-center">❌Contract Renoucned❌</div> </div>
